...
var apiService = builder.AddProject<Projects.MacMaui_ApiService>("apiservice")
    .WithHttpHealthCheck("/health");

builder.AddProject<Projects.MacMaui_Web>("webfrontend")
...
var mobile = builder.AddMauiProject(
    "mobile",
    "../MacMaui.Mobile/MacMaui.Mobile.csproj");
